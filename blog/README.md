...
GridDB Cloud offers a free plan tier and is officially available worldwide. More details, to get started with it, follow this [quick start guide](https://griddb.net/en/blog/griddb-cloud-quick-start-guide/).

The GridDB Cloud database will store the structured information extracted by the Profile Analyst agent and also the final resume generated by the Resume Writer agent.
...
Create a new user in the **GridDB Users** section of the GridDB Cloud portal and setup the database permission. Copy the username and password for the `.env` file.
